...
const client = ipfsHttpClient('https://ipfs.infura.io:5001/api/v0') // There are other node to work with
...
export default function CreateItem() {
  ...
  async function createSale(url) {
    ...
    let contract = new ethers.Contract(nftaddress, decent.abi, signer)
    ...
    contract = new ethers.Contract(nftmarketaddress, decentmarket.abi, signer)
